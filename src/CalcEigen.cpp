...
static long double hypot2(long double x, long double y) {
  return sqrt(x*x+y*y);
}

// Symmetric Householder reduction to tridiagonal form.

static void tred2(int n, long double **V, long double *d, long double *e) {
...
static void tql2(int n, long double **V, long double *d, long double *e) {
...
//  Fortran subroutine in EISPACK.
  ...
  for (int l = 0; l < n; l++) {
    ...
    if (m > l) {
      ...
      } while (fabs(e[l]) > 1.0e-10*eps*tst1);
    }
    d[l] = d[l] + f;
    e[l] = 0.0;
  }
